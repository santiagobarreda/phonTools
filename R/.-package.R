...
#' \item{list("sex")}{ - A factor indicating speaker sex.}
#' \item{list("vowel")}{ - The vowel category in x-sampa.} \item{list("f1")}{ -
#' A numeric vector indcating the vowel F1 in Hz.} \item{list("f2")}{ - A
#' numeric vector indcating the vowel F2 in Hz.} \item{list("f3")}{ - A numeric
#' vector indcating the vowel F3 in Hz.} \item{list("f4")}{ - A numeric vector
#' indcating the vowel F4 in Hz.} }
...
#' \item{list("vowel")}{ - The vowel category in x-sampa.} \item{list("f1")}{ -
#' A numeric vector indcating the vowel F1 in Hz.} \item{list("f2")}{ - A
#' numeric vector indcating the vowel F2 in Hz.} }
...
#' \describe{ \item{list("type")}{ - A factor with levels \code{b} \code{g}
#' \code{m} \code{w} representing speaker type: boy, girl, man and woman.}
#' \item{list("speaker")}{ - A numeric vector indicating a uniquely identifying
#' speaker number.} \item{list("vowel")}{ - The vowel category in x-sampa}
#' \item{list("dur")}{ - A numeric vector indicating the duration of the vowel
#' in milliseconds.} \item{list("f0")}{ - A numeric vector indcating the vowel
#' f0 in Hz.} \item{list("f1")}{ - A numeric vector indcating the vowel F1 in
#' Hz.} \item{list("f2")}{ - A numeric vector indcating the vowel F2 in Hz.}
#' \item{list("f3")}{ - A numeric vector indcating the vowel F3 in Hz.} }
...
#' A numeric vector indcating the vowel F1 in Hz.} \item{list("f2")}{ - A
#' numeric vector indcating the vowel F2 in Hz.} \item{list("f3")}{ - A numeric
#' vector indcating the vowel F3 in Hz.} }
...
#' \describe{ \item{list("type")}{ - A factor with levels \code{c} \code{m}
#' \code{w} representing speaker type: child, man and woman.}
#' \item{list("sex")}{ - A factor with levels \code{f} \code{m} representing
#' speaker gender: male and female.} \item{list("speaker")}{ - A numeric vector
#' indicating a uniquely identifying speaker number.} \item{list("vowel")}{ -
#' The vowel category in x-sampa.} \item{list("repetition")}{ - A numeric
#' vector indicating the repetition number.} \item{list("f0")}{ - A numeric
#' vector indcating the vowel f0 in Hz.} \item{list("f1")}{ - A numeric vector
#' indcating the vowel F1 in Hz.} \item{list("f2")}{ - A numeric vector
#' indcating the vowel F2 in Hz.} \item{list("f3")}{ - A numeric vector
#' indcating the vowel F3 in Hz.} }
...
#' @docType data
#' @format A data frame with 1520 observations on the following 9 variables:
#' \describe{ \item{list("vowel")}{ - The vowel category in x-sampa.}
#' \item{list("gender")}{ - A factor with levels \code{f} \code{m} representing
#' speaker gender: male and female.} \item{list("f1")}{ - A numeric vector
#' indcating the vowel F1 in Hz.} \item{list("f2")}{ - A numeric vector
#' indcating the vowel F2 in Hz.} \item{list("f3")}{ - A numeric vector
#' indcating the vowel F3 in Hz.} }
...
#' @name voweldata
#' @docType data
#' @format A data frame with the following information: \describe{
#' \item{list("name")}{ - The name of the data set.} \item{list("language")}{ -
#' The language represented in the data set.} \item{list("nspeakers")}{ - The
#' number of speakers.} \item{list("sexes")}{ - The sexes of the speakers, m
#' (male) and female (f).} \item{list("nformants")}{ - The number of formants
#' represented, between 2 and 4.} \item{list("individual")}{ - If 'yes',
#' individual speaker measurements are given, if 'no', measurements are
#' averaged within gender.} }
